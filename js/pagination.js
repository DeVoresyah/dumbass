...
if (nomerhal == 2) {
if (jenis == "page") {
html += '<li><a href="' + home_page + '">' + upPageWord + '</a></li>'
} else {
html += '<li><a href="/search/label/' + lblname1 + '?max-results=' + postperpage + '">' + upPageWord + '</a></li>'
}
} else {
if (jenis == "page") {
...
html += '<li><a href="/search/label/' + lblname1 + '?max-results=' + postperpage + '">1</a></li>'
}
}
if (mulai > 2) {
html += ' ... '
